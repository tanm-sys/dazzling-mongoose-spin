...
const MathPreview: React.FC = () => {
  ...
  return (
    <section
      id="math-preview"
      className="relative bg-gradient-to-b from-background to-background/40 py-20"
    >
      <ScrollReveal>
          ...
          <Card className="order-2 md:order-1">
            ...
            <CardContent className="space-y-6">
              <p className="text-foreground/70">
                Visualize residues on a circle and connect i → k·i mod n.
                Patterns reveal structure — a peek into number theory behind
                cryptography.
              </p>
